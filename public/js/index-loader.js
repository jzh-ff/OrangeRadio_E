...
(function loadMineradioIndexModules() {
  ...
  const modulePaths = [    'js/modules/00-state/00-core-stores.js',
    ...
    'js/modules/02-visual/17-genre-world-registry.js',
    'js/modules/02-visual/18-genre-world-engine.js',
    'js/modules/02-visual/19-genre-world-transition.js',
    'js/modules/02-visual/20-genre-world-performance.js',
    'js/modules/02-visual/genre-worlds/00-shared-primitives.js',
    'js/modules/02-visual/genre-worlds/01-electronic.js',
    'js/modules/02-visual/genre-worlds/02-rock-metal.js',
    'js/modules/02-visual/genre-worlds/03-hiphop.js',
    'js/modules/02-visual/genre-worlds/04-prism.js',
    'js/modules/02-visual/genre-worlds/05-folk.js',
    'js/modules/02-visual/genre-worlds/06-classical.js',
    'js/modules/02-visual/genre-worlds/07-jazz-soul.js',
    'js/modules/02-visual/genre-worlds/08-ambient.js',
    ...
    'js/modules/05-playback/19-equalizer.js',
    'js/modules/05-playback/20-sleep-timer.js',
    'js/modules/05-playback/21-song-download.js',
    'js/modules/05-playback/22-listen-report.js',
    ...
    'js/modules/06-lyrics/08-genre-world-lyrics.js',
    ...
    'js/modules/07-fx/10-concert-live-stage.js',
